...
import { CheckIcon, FlameIcon, StarIcon } from "@/components/icons";
...
export default function DashboardPage() {
  ...
  return (
    <main className="mx-auto max-w-page-wide px-6 py-10">
      {/* Greeting + glanceable stats */}
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h1 className="font-display text-title font-semibold text-accent">
            Tervetuloa!
          </h1>
        ...
        <ul className="flex gap-3 text-sm">
          <li className="flex items-center gap-1.5 rounded-chip border border-line bg-surface px-3 py-2">
            <FlameIcon className="h-4 w-4 text-amber-deep" />
            <span className="font-semibold tnum">{progress.streak}</span> päivää
          </li>
          <li className="flex items-center gap-1.5 rounded-chip border border-line bg-surface px-3 py-2">
            <StarIcon className="h-4 w-4 text-amber-deep" />
      ...
      <section className="mt-8 flex flex-col items-center gap-6 rounded-card border border-line bg-surface p-6 shadow-soft sm:flex-row sm:items-center">
        ...
        <div className="flex-1 text-center sm:text-left">
          ...
          <ButtonLink href="/learn" className="mt-4">
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2">
        ...
        {reviewWord ? (
          ...
          >
            <h3 className="font-display text-xl">Kertaa virheet ({again.length})</h3>
      ...
      <section className="mt-8">
        <div className="flex items-baseline justify-between gap-3">
          <h2 className="font-display text-xl">Rozetit</h2>
