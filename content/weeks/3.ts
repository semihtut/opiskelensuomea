...
const week3: Week = {
  ...
  days: [
    ...
    { day: 2, theme: "Yleiset verbit I: havainnot ja viestintä", wordSlugs: [] },
    { day: 3, theme: "Yleiset verbit II: toiminta ja muutos", wordSlugs: [] },
    { day: 4, theme: "Kaupunki ja palvelut", wordSlugs: [] },
    { day: 5, theme: "Koti ja esineet", wordSlugs: [] },
